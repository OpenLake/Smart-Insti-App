  ...
  void buildMenuTiles(BuildContext context) {
    List<MenuTile> menuTiles = [
      MenuTile(
        ...
        secondaryColor: UltimateTheme.primary.withValues(alpha: 0.2),
      ),
      MenuTile(
        title: "Lost & Found",
        onTap: () => context.push('/user_home/lost_and_found'),
        primaryColor: UltimateTheme.accent,
        secondaryColor: UltimateTheme.accent.withValues(alpha: 0.2),
      ...
      MenuTile(
        ...
        secondaryColor: UltimateTheme.navy.withValues(alpha: 0.2),
