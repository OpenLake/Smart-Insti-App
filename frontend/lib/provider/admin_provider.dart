...
class AdminNotifier extends StateNotifier<AdminState> {
  ...
  void buildMenuTiles(BuildContext context) {
    List<MenuTile> menuTiles = [
      MenuTile(
        title: "Add\nStudents",
        onTap: () => context.push('/admin_login/admin_home/add_students'),
        icon: Icons.add,
      ...
      MenuTile(
        title: "View\nStudents",
        onTap: () => context.push('/admin_login/admin_home/view_students'),
        icon: Icons.add,
      ...
      MenuTile(
        title: "Add\nCourses",
        onTap: () => context.push('/admin_login/admin_home/add_courses'),
        icon: Icons.add,
      ...
      MenuTile(
        title: "View\nCourses",
        onTap: () => context.push('/admin_login/admin_home/view_courses'),
        icon: Icons.add,
      ...
      MenuTile(
        title: "Add\nFaculty",
        onTap: () => context.push('/admin_login/admin_home/add_faculty'),
        icon: Icons.add,
      ...
      MenuTile(
        title: "View\nFaculty",
        onTap: () => context.push('/admin_login/admin_home/view_faculty'),
        icon: Icons.add,
      ...
      MenuTile(
        title: "Add\nMess\nMenu",
        onTap: () => context.push('/admin_login/admin_home/add_menu'),
        icon: Icons.add,
      ...
      MenuTile(
        title: "View\nMess\nMenu",
        onTap: () => context.push('/admin_login/admin_home/view_menu'),
        icon: Icons.add,
      ...
      MenuTile(
        title: "Manage\nRooms",
        onTap: () => context.push('/admin_login/admin_home/manage_rooms'),
        icon: Icons.add,
