...
final alumniFiltersProvider =
    FutureProvider.autoDispose<Map<String, dynamic>>((ref) async {
  return ref.read(alumniServiceProvider).getFilters();
});

final alumniListProvider = FutureProvider.autoDispose
    .family<List<dynamic>, Map<String, String?>>((ref, filters) async {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            leading: CircleAvatar(
                              radius: 28,
                              backgroundImage: alum['profilePicURI'] != null
                                  ? NetworkImage(alum['profilePicURI'])
                                  : null,
                              child: alum['profilePicURI'] == null
                                  ? Text(alum['name'][0])
                                  : null,
                            ),
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                if (alum['designation'] != null ||
                                    alum['currentOrganization'] != null)
                                  Text(
                            ...
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => AlumniProfileScreen(
                                          alumniData: alum)));
                            },
                          ),
                        );
  ...
  Widget _buildFilterChip(String label, bool isSelected, VoidCallback onTap) {
    return Padding(
      ...
      child: FilterChip(
        ...
        selected: isSelected,
        onSelected: (_) => onTap(),
        selectedColor: UltimateTheme.primaryColor.withValues(alpha: 0.2),
