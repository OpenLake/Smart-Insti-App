            ...
            child: Column(
              ...
              children: [
                ...
                GridView.count(
                  ...
                  children: [
                    _buildStatCard("Students", counts['students'].toString(),
                        Icons.school, Colors.blue),
                    _buildStatCard("Faculty", counts['faculty'].toString(),
                        Icons.person_pin, Colors.purple),
                    _buildStatCard("Active Polls", counts['polls'].toString(),
                        Icons.poll, Colors.orange),
                    _buildStatCard("Events", counts['events'].toString(),
                  ...
                  children: [
                    Expanded(
                        child: _buildStatCard(
                            "Pending",
                            counts['complaints']['pending'].toString(),
                    ...
                    Expanded(
                        child: _buildStatCard(
                            "Resolved",
                            counts['complaints']['resolved'].toString(),
                            Icons.check_circle,
                            Colors.teal)),
                  ],
                ),
                ...
                ...recentComplaints
                    .map((c) => Card(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Text(c['student']?['name'] ?? 'Unknown',
                                style: GoogleFonts.outfit()),
                            trailing: Chip(
                              label: Text(c['status']),
