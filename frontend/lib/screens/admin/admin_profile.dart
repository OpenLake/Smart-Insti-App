        ...
        body: Consumer(
          builder: (_, ref, __) {
            ...
            if (authState.currentUser == null ||
                authState.currentUser is! Admin) {
              return const Center(child: CircularProgressIndicator());
            } else {
              Admin admin = authState.currentUser as Admin;
              return Center(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text('Admin Profile',
                          style: TextStyle(fontSize: 35, fontFamily: 'Jost')),
                      const SizedBox(height: 20),
                      MaterialTextFormField(
                          hintText: "Admin Name",
                          enabled: false,
                          controllerLessValue: admin.name),
                      const SizedBox(height: 20),
                      MaterialTextFormField(
                          hintText: "Admin Email",
                          enabled: false,
                          controllerLessValue: admin.email),
                    ],
                  ),
                ),
              );
