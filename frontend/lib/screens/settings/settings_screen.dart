      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSwitchTile("Show Email", "Visible to other students",
                _showEmail, (val) => setState(() => _showEmail = val)),
            _buildSwitchTile(
                "Show Achievements",
