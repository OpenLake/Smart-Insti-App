          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: Stack(
                ...
                children: [
                  if (club.banner != null)
                    Image.network(club.banner!, fit: BoxFit.cover),
                  Container(
          ...
          return Container(
            ...
            child: Column(
              children: [
                CircleAvatar(
                  radius: 30,
                  backgroundImage: member.profilePicURI != null
                      ? NetworkImage(member.profilePicURI!)
                      : null,
                  child: member.profilePicURI == null
                ...
                Text(member.role,
                    style: GoogleFonts.outfit(
                        color: UltimateTheme.primaryColor, fontSize: 10),
                    textAlign: TextAlign.center,
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis),
              ],
