...
class _QRScannerScreenState extends ConsumerState<QRScannerScreen>
  ...
  Future<void> _processBarcode(BarcodeCapture capture) async {
    ...
    try {
      ...
      if (mounted) {
        _showResultDialog(
            result['message'] ?? "Processing...", result['status'] == true);
      }
    } catch (e) {
      if (mounted) {
              ...
              content: Column(
                ...
                children: [
                  Icon(success ? Icons.check_circle : Icons.error,
                      color: success ? Colors.green : Colors.red, size: 64),
                  ...
                  Text(message,
                      textAlign: TextAlign.center, style: GoogleFonts.outfit()),
                ],
              ),
              actions: [
                TextButton(
          ...
          Center(
            child: Container(
              ...
              decoration: BoxDecoration(
                  border:
                      Border.all(color: UltimateTheme.primaryColor, width: 4),
                  borderRadius: BorderRadius.circular(16)),
            ),
          ),
          Positioned(
