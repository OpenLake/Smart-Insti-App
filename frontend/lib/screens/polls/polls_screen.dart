  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label:
            Text("Create Poll", style: GoogleFonts.outfit(color: Colors.white)),
      ),
    );
  }
}
...
class _PollCardState extends ConsumerState<_PollCard> {
  ...
  Future<void> _vote(int index) async {
    ...
    final result =
        await ref.read(pollServiceProvider).vote(widget.poll['_id'], index);
    ...
    return SizedBox(
      ...
      child: OutlinedButton(
        ...
        child: _voting
            ...
            : Text(text,
                style: GoogleFonts.outfit(color: UltimateTheme.primaryColor)),
      ),
    );
  }
      ...
      children: [
        ...
        ClipRRect(
          ...
          child: LinearProgressIndicator(
            ...
            valueColor:
                const AlwaysStoppedAnimation<Color>(UltimateTheme.primaryColor),
            minHeight: 8,
          ),
        ),
      ],
