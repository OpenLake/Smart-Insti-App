...
class _ListingDetailScreenState extends ConsumerState<ListingDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final listing = state.listings.firstWhere((l) => l.id == widget.listingId,
        orElse: () => Listing(
            id: '',
            title: '',
            description: '',
    ...
    if (listing.id.isEmpty) {
      ...
      return const Scaffold(
          body: Center(child: Text("Listing not found or loading...")));
    }
              ...
              delegate: SliverChildListDelegate([
                ...
                ListTile(
                  ...
                  leading: CircleAvatar(
                      backgroundImage: listing.sellerImage.isNotEmpty
                          ? NetworkImage(listing.sellerImage)
                          : null,
                      child: listing.sellerImage.isEmpty
                          ? Text(listing.sellerName[0])
                          : null),
